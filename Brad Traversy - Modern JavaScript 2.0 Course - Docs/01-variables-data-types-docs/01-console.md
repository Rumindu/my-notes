...
- In my word, Here `console` is a object and `log` is one of methods in the `console` object.
### `console.log()`
...
We are using `.` operator to access properties(variables) and methods in the object.
#### Log a number
...
```JavaScript
console.group('simple');//Initaiting group called simple
console.warn('warning!');
console.error('error here');
console.log('Hello World');
console.groupEnd('simple');// end of the group called simple
console.log('new section');
```
![](images/Pasted%20image%2020250503232558.png)
#### Log with style
